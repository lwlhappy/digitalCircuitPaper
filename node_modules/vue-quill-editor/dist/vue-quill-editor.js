!function (t, e) {
    ...
    return function (t) {
        ...
        var i = n(4), l = n.n(i), o = n(6), r = n(5), u = r(l.a, o.a, !1, null, null, null);
        e.default = u.exports
    }, function (t, e, n) {
        "use strict";
        ...
        var l = n(0), o = i(l), r = n(1), u = i(r), s = window.Quill || o.default, a = function (t, e) {
            ...
            methods: {
                initialize: function () {
                    ...
                    this.$el && (this._options = Object.assign({}, this.defaultOptions, this.globalOptions, this.options), this.quill = new s(this.$refs.editor, this._options), this.quill.enable(!1), (this.value || this.content) && this.quill.pasteHTML(this.value || this.content), this.disabled || this.quill.enable(!0), this.quill.on("selection-change", function (e) {
                        ...
                        var l = t.$refs.editor.children[0].innerHTML, o = t.quill, r = t.quill.getText();
        ...
        t.exports = function (t, e, n, i, l, o) {
            var r, u = t = t || {}, s = typeof t.default;
        ...
        var i = function () {
            ...
            return n("div", {staticClass: "quill-editor"}, [t._t("toolbar"), t._v(" "), n("div", {ref: "editor"})], 2)
